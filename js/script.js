$(()=>{
//https://api.openweathermap.org/data/2.5/weather?q=${cityInput}&units=metric&appid=8de34fe193f5396bc8ece49b21d39f05
    $('#weather-app-btn').click(function(event){
        ...
        $( ".slider" ).val(0);
        let apiUrl = `https://api.openweathermap.org/data/2.5/forecast?q=${cityInput}&units=metric&cnt=16&appid=8de34fe193f5396bc8ece49b21d39f05`
        $.getJSON(apiUrl, {
        }).done((data) => {
            console.log(data);
    ...
    let apiUrl = `https://api.openweathermap.org/data/2.5/group?id=2673730,3169070,2643743,1850144&units=metric&appid=8de34fe193f5396bc8ece49b21d39f05`
        $.getJSON(apiUrl, { 
        }).done((data) => {
